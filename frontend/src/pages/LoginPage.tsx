    ...
    >
      <div className="learning-pathway absolute w-full h-full overflow-hidden z-0 pointer-events-none">
        <svg className="absolute w-full h-full opacity-35" fill="none" viewBox="0 0 1440 800" xmlns="http://www.w3.org/2000/svg">
          ...
          <path className="stroke-dasharray-[10,10]" d="M1500 750C1200 600 1000 650 720 400C440 150 200 200 -50 50" stroke="#FF5F05" strokeWidth={4} />
          <path className="stroke-dasharray-[10,10]" d="M100 200C400 350 800 150 1200 300" stroke="#009FD4" strokeWidth={3} />
          <circle className="opacity-25" cx="10%" cy="20%" fill="#C8C6C7" r="40" />
          <circle className="opacity-25" cx="85%" cy="75%" fill="#FFE8D6" r="60" />
          <circle className="opacity-25" cx="90%" cy="15%" fill="#FCB316" r="30" />
          <circle className="opacity-20" cx="50%" cy="85%" fill="#009FD4" r="50" />
          <circle className="opacity-20" cx="70%" cy="40%" fill="#FF5F05" r="35" />
        ...
        <div className="absolute bottom-[15%] left-[10%] rotate-45 text-illini-blue/15">
          <span className="material-symbols-outlined text-[120px]">rocket_launch</span>
        </div>
        <div className="absolute top-[10%] right-[12%] -rotate-[15deg] text-primary/20">
          <span className="material-symbols-outlined text-[80px]">rocket_launch</span>
        </div>
        <div className="absolute top-[60%] left-[5%] rotate-12 text-arches/15">
