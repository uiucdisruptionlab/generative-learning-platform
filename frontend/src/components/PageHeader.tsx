...
export default function PageHeader({ sidebarOpen, onToggleSidebar, title, description, action }: PageHeaderProps) {
  return (
    <header className="bg-gradient-to-r from-illini-blue via-primary to-illini-orange backdrop-blur-xl sticky top-0 z-20 border-b-2 border-illini-orange/30 px-8 py-8 sm:px-12 sm:py-10 shrink-0">
